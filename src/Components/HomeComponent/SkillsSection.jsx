...
import { GraduationCap, Hourglass, Wrench } from "lucide-react";
      ...
      <div className="container mx-auto px-6 md:flex   gap-10 items-center">
        ...
        >
          <img
            src="p.jpg"
            alt="Profile 1"
            className="absolute top-0 right-0  object-cover rounded-3xl shadow-2xl z-10"
          />
        ...
        <div className="flex flex-col gap-y-6">
          {[
            ...
            },
            {
              ...
              icon: <Hourglass size={24} color="#f59e0b" />,
            },
            {
              ...
              icon: <Wrench size={24} color="#374151" />,
            },
          ].map((card, index) => (
            <motion.div
              key={index}
